...
version = phutanu.__version__
# The full version, including alpha/beta/rc tagss
release = phutanu.__version__
...
man_pages = [
    (master_doc, 'Page1 Header', 'Page2 Header', u'Recommonmark Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Recommonmark', u'VeriStand Manual',
